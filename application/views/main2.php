...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand-md navbar-dark navbar-cyan">
    <div class="container">
      <a href="<?php echo base_url(); ?>" class="navbar-brand">
        <img src="<?php echo base_url(); ?>assets/logo_dikpora.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
             style="opacity: .9">
  ...
  <footer class="main-footer">
    ...
    <div class="float-right d-none d-sm-inline">
      #OjoGumunan #OjoKagetan #OjoNesunan #TetapSehat #DirumahSaja
    </div>
    <!-- Default to the left -->
    <strong>Copyright &copy; 2021 <a href="https://tphbs.jogjacbt.web.id">JogjaCBT</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
